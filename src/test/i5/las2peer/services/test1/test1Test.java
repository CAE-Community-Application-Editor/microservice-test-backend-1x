...
/**
 *
 * test-backend-1x - Test Class
 *
 * This class provides a basic testing framework for the microservice test-backend-1x. It was
...
public class test1Test {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(test1.class.getCanonicalName(),"0.1");
  ...
  public void testtest1() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("GET", mainPath + "//a", "",
